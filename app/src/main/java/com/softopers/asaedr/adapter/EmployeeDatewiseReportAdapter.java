...
public class EmployeeDatewiseReportAdapter extends ArrayAdapter<DateList> {

    public EmployeeDatewiseReportAdapter(Context context, ArrayList<DateList> dateLists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!PrefUtils.getUser(getContext()).getIsAdmin()) {
            if (!dateList.getIsLock()) {
                ...
                viewHolder.relativeLayout.setBackgroundColor(Color.parseColor("#F2F2F2"));
            }
        }
