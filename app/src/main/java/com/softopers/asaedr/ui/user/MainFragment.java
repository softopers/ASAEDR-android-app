...
public class MainFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    private void requestDataRefresh() {
        ...
        intent.putExtra(RestAPIClientService.Operation.class.getName(), RestAPIClientService.Operation.EMPLOYEE_DATE_WISE_REPORTS_BY_EMAIL_ID);
        intent.putExtra(App.REQUEST_BY_EMP_EMAIL_ID, requestByIds);
            ...
            public void run() {
                ...
                mCollectionView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Log.v("dateList", String.valueOf(dateList.getIsLock()));
                        Intent intent = new Intent(getActivity(), ReportingActivity.class);
                        if (!dateList.getIsLock()) {
                            intent.putExtra("isLock", false);
                        } else {
                            intent.putExtra("isLock", true);
                        }
                        intent.putExtra("DayStatusId", dateList.getDayStatusId());
