...
public class ReportsFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    private void requestDataRefresh() {
        ...
        intent.putExtra(RestAPIClientService.Operation.class.getName(), RestAPIClientService.Operation.ADMIN_EMPLOYEE_TAB1);
        intent.putExtra(App.ADMIN_EMPLOYEE_TAB1, requestByIds);
