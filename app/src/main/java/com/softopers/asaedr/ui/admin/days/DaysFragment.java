 ...
 */
public class DaysFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    private void requestDataRefresh() {
        ...
        if (getArguments().getString("unlock") != null) {
            intent.putExtra(RestAPIClientService.Operation.class.getName(), RestAPIClientService.Operation.DAYS_UNLOCK);
            intent.putExtra(App.DAYS_UNLOCK, requestByIds);
        } else {
            intent.putExtra(RestAPIClientService.Operation.class.getName(), RestAPIClientService.Operation.DAYS_LOCK);
            intent.putExtra(App.DAYS_LOCK, requestByIds);
        }
            ...
            public void run() {
                ...
                mCollectionView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getActivity(), DaysEmployeesActivity.class);
